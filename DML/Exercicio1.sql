-- Active: 1728688414725@@127.0.0.1@3306@exercicio1_dml
...
FROM participantes
WHERE TIMESTAMPDIFF(YEAR,DATA_NASC,NOW()) >40;*/
SELECT * FROM PARTICIPANTES WHERE 
#SELECT COLUNA FROM TABELA WHERE CONDICIONAL_COLUNA AND CONDICIONAL_COLUNA > CONDICIONAL;
